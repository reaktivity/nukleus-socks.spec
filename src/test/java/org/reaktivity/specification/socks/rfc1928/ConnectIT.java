...
public class ConnectIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("scripts", "org/reaktivity/specification/socks/rfc1928/connect");
    ...
    @Test
    @Specification({
        "${scripts}/rejected.connection.not.allowed.by.ruleset/client",
        "${scripts}/rejected.connection.not.allowed.by.ruleset/server"})
    public void shouldRejectWithConnectionNotAllowedByRuleset() throws Exception
    {
        k3po.start();
        k3po.notifyBarrier("ROUTED_SERVER");
        k3po.finish();
    ...
    @Test
    @Specification({
        "${scripts}/rejected.connection.refused/client",
        "${scripts}/rejected.connection.refused/server"})
    public void shouldRejectWithConnectionRefused() throws Exception
    {
        k3po.start();
        k3po.notifyBarrier("ROUTED_SERVER");
        k3po.finish();
